...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  return (
    ...
    >
      ...
      <a href="#mobile" onClick={onClose} className="font-serif text-2xl font-light tracking-[0.05em] text-ink no-underline transition-colors duration-200 hover:text-red-600">Mobiler Service</a>
