...
export default function FloatingActions() {
  ...
  const btnClass = `flex h-[44px] w-[44px] cursor-pointer items-center justify-center rounded-full border border-glass-border bg-glass text-ink backdrop-blur-[10px] transition-all duration-500 ease-out hover:border-red-600 hover:bg-glass-hover hover:text-red-600`;
