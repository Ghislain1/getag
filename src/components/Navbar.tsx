    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          {scrolled && (
            <>
              <a href="https://wa.me/49000000000" target="_blank" rel="noopener noreferrer" className="flex h-[38px] w-[38px] items-center justify-center rounded-full border border-glass-border bg-glass text-base text-ink transition-all duration-300 hover:border-red-600 hover:bg-glass-hover" aria-label="WhatsApp">
