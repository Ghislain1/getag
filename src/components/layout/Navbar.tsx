    ...
    <>
      ...
      >
        ...
        <ul className="hidden items-center gap-8 md:flex" style={{ listStyle: 'none' }}>
          ...
          <li><a href="#ueber-mich" className="relative text-[0.82rem] uppercase tracking-[0.08em] text-ink-2 no-underline transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:right-0 after:h-px after:origin-right after:scale-x-0 after:bg-red-600 after:transition-transform after:duration-300 hover:text-ink hover:after:origin-left hover:after:scale-x-100">Über mich</a></li>
          <li><a href="#galerie" className="relative text-[0.82rem] uppercase tracking-[0.08em] text-ink-2 no-underline transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:right-0 after:h-px after:origin-right after:scale-x-0 after:bg-red-600 after:transition-transform after:duration-300 hover:text-ink hover:after:origin-left hover:after:scale-x-100">Galerie</a></li>
          <li><a href="#reviews" className="relative text-[0.82rem] uppercase tracking-[0.08em] text-ink-2 no-underline transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:right-0 after:h-px after:origin-right after:scale-x-0 after:bg-red-600 after:transition-transform after:duration-300 hover:text-ink hover:after:origin-left hover:after:scale-x-100">Reviews</a></li>
        </ul>
        <div className="flex items-center gap-4">
          ...
          {scrolled && (
            <>
              ...
              <GradientWrap>
                <a href="https://wa.me/004915259269888" target="_blank" rel="noopener noreferrer" className="relative inline-block rounded-full bg-[var(--bg)] px-5 py-1.5 text-[0.75rem] font-medium uppercase tracking-[0.08em] text-ink no-underline transition-colors duration-300 hover:text-[var(--accent)]">
                  Buchen
                </a>
              </GradientWrap>
            </>
